...
export const Skills = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["React", "Tailwind CSS", "Framer Motion", "Responsive UI", "Glassmorphism", "Component Architecture"],
    ...
    },
    {
      ...
      skills: ["FastAPI", "API Design", "Backend Frameworks", "Automation", "Data Processing"],
    ...
    },
    {
      ...
      skills: ["Cybersecurity Fundamentals", "Penetration Testing", "Security Monitoring", "Honeypot Systems", "Encryption"],
    ...
    },
    {
      ...
      skills: ["GitHub", "OpenAI API", "Power BI", "AWS", "Linux", "Kali Linux"],
    ...
    },
    {
      ...
      skills: ["DSA", "OOP", "STL", "Automation Systems", "IoT Integration", "Sensor Data Processing"],
